...
- [ ] **Step 2: Program spec A5, A10, A12 as measured (the #5 hand-off)**
...
- [ ] **Step 3: Design on #5 (durable decision)**
...
- [ ] **Step 4: Denylist-scan the docs without touching the index, then commit**
...
- [ ] **Step 1: RED — a file with several vectors keeps all of them**
...
- [ ] **Step 2: GREEN — open each vector file once**
...
- [ ] **Step 3: Regenerate from the raw renders and prove only the vectors changed**
...
- [ ] **Step 1: The module with its tests**
...
- [ ] **Step 2: Commit** (`cargo fmt --all` first; proven in CI at Task 9)
...
- [ ] **Step 1: Crate manifest and root**
...
- [ ] **Step 3: Pan law, send gains, downmix, `StereoGain` (A5, A10)**
...
- [ ] **Step 4: Meters and sanitiser (F9, X14, X1)**
...
- [ ] **Step 1: The module with its unit tests**
...
- [ ] **Step 1: Golden parity (1294 EQ vectors, response, pan table, pan renders, downmix)**
...
- [ ] **Step 2: Allocation-free process paths (own test binary: it installs the global allocator)**
...
- [ ] **Step 3: Block-size invariance and fuzz**
...
- [ ] **Step 3: Literal translation, REAPER goldens, block sizes**
...
- [ ] **Step 4: Allocation-free and fuzz**
...
- [ ] **Step 2: The `fuzz` job (per run seed) with the release-mode golden report**
...
- [ ] **Step 1: Push `dev` (pre-push hook: gitleaks, denylist, identities) and wait in the foreground**
...
- [ ] **Step 2: Read the parity report and the mutant count**
...
- [ ] **Step 2: Commit and push with the last CI cycle**
